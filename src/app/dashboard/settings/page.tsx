                    ...
                    <div className="bg-dark-2 border border-white/10 rounded-[32px] p-8 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            <textarea
                                ...
                                rows={3}
                                placeholder="Enjoyed the food? Visit us again! Please make payment at the counter. 🙏"
                                maxLength={200}
                            />
                            <p className="text-[10px] text-text-muted opacity-60 ml-1">
                                Tip: You can also add payment instructions here — "Please pay at the counter"
                            </p>
                        </div>
                    </div>
