  ...
  return (
    <div className="inventory-container animate-fade-in">
            ...
            {suppliers.map(supplier => (
              <div key={supplier.id} className="supplier-card">
                ...
                <div className="flex gap-2">
                  <a 
                    href={`https://wa.me/91${supplier.phone}?text=Hello ${supplier.name}! I need to place a stock order.`}
                    target="_blank"
      ...
      {isAddStockModalOpen && selectedItem && (
        <div className="fixed inset-0 z-1000 flex items-center justify-center p-4 modal-overlay">
          <div className="modal-content w-full max-w-md">
            <h2 className="text-2xl font-fraunces mb-2">Add Stock</h2>
      ...
      {isLinkModalOpen && selectedMenuitem && (
        <div className="fixed inset-0 z-1000 flex items-center justify-center p-4 modal-overlay">
          <div className="modal-content w-full max-w-md">
            <h2 className="text-2xl font-fraunces mb-2">Link Ingredient</h2>
